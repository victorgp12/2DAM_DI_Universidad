...
class Ui_HomeWindow(object):
    def setupUi(self, HomeWindow):
        ...
        self.scrollArea.setMinimumSize(QSize(25, 250))
        ...
        sizePolicy1.setHeightForWidth(self.menuWidget.sizePolicy().hasHeightForWidth())
        self.menuWidget.setSizePolicy(sizePolicy1)
        ...
        self.menubar.setGeometry(QRect(0, 0, 1143, 33))
